...
export default function NotFound() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#FCFCFD] px-4 font-sans text-slate-900 overflow-hidden">
      {/* Abstract Blurred Background */}
      <div className="absolute top-0 left-0 right-0 h-[600px] bg-linear-to-br from-blue-100/60 via-sky-50/30 to-transparent blur-[100px] pointer-events-none z-0" />
      <div className="absolute bottom-0 right-0 w-[600px] h-[500px] bg-linear-to-tl from-sky-100/60 via-blue-50/30 to-transparent blur-[100px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 p-10 max-w-md w-full text-center flex flex-col items-center gap-5">
        ...
        <p className="text-slate-500/90 font-medium">
