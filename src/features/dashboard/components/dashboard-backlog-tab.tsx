...
export function DashboardBacklogTab({ q }: DashboardBacklogTabProps) {
  ...
  // Flatten issues and attach status for a generic backlog view
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-[13px] text-slate-500 mt-1">
              {filteredIssues.length} issues remaining
            </p>
          </div>
        </div>
